...
export function iterationIsValid(
  ...
  if (iterations > 20 && uiEvent != "cut" && !isMassReplace) {
    console.error(
      "@inscribe/plugins track-changes: Possible infinite loop in iterating tr.steps, tracking skipped!\n" +
    ...
    console.error(
      "@inscribe/plugins track-changes: Multiple prosemirror-transform packages imported, alias/dedupe them " +
