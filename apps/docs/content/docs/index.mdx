---
title: Introduction
description: Scrivr is a canvas-based, paginated document editor built on ProseMirror and Yjs.
---

<Callout type="warn">
  Scrivr is currently in **beta**. APIs may change between releases. We recommend pinning to an
...
<Cards>
  <Card title="@scrivr/core" href="/packages/core">
  ...
  <Card title="@scrivr/react" href="/packages/react">
    React bindings — `useScrivrEditor` hook, `<Scrivr />` component, and contextual menus.
  </Card>
  <Card title="@scrivr/plugins" href="/packages/plugins">
    Optional extensions — AI Toolkit, Track Changes, and real-time collaboration via Yjs.
  </Card>
  <Card title="@scrivr/export" href="/packages/export">
    Export utilities — paginated PDF (via `pdf-lib`) and Markdown. DOCX coming soon.
  </Card>
  <Card title="@scrivr/vue">
    <span class="inline-block mb-2 rounded-md bg-orange-100 px-2 py-0.5 text-xs font-medium text-orange-700 dark:bg-orange-900/40 dark:text-orange-400">Coming Soon</span> Vue 3 bindings — `useScrivrEditor` composable and `<Scrivr />` component.
  </Card>
  <Card title="@scrivr/svelte">
    <span class="inline-block mb-2 rounded-md bg-orange-100 px-2 py-0.5 text-xs font-medium text-orange-700 dark:bg-orange-900/40 dark:text-orange-400">Coming Soon</span> Svelte bindings — `createScrivrEditor` store and `<Scrivr />` component.
  </Card>
</Cards>
