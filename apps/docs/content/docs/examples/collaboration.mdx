...
description: Full backend and frontend setup for multiplayer editing with Scrivr.
---
...
Scrivr's collaboration layer uses **Yjs** CRDTs to merge concurrent edits. The library owns
...
Scrivr's collaboration protocol is compatible with any [Hocuspocus](https://hocuspocus.dev/) server.
