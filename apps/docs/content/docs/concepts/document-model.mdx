...
description: How Scrivr represents documents using ProseMirror's node tree — and how that maps to the canvas renderer.
---

Scrivr uses [ProseMirror](https://prosemirror.net/) as its document model. ProseMirror provides an
...
Scrivr has **no hardcoded node types**. The ProseMirror schema is assembled from the extensions you
