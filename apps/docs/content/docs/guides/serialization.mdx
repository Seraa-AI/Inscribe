...
Scrivr stores the document as an immutable ProseMirror `EditorState`. This guide covers how to
...
Use `ServerEditor` from `@scrivr/core` to parse and transform documents in Node.js
...
full [@scrivr/export package reference](/packages/export).
